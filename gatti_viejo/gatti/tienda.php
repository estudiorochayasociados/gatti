...
<head>
  ...
  $categoria = str_replace("-"," ",isset($_GET["categoria"]) ? $_GET["categoria"] : '');
  $subcategoria = str_replace("-"," ",isset($_GET["subcategoria"]) ? $_GET["subcategoria"] : '');
  $productos = isset($_GET["id"]) ? $_GET["id"] : '';
  $categoria = (str_replace("Ñ", 'N', $categoria));
  ?>
  <title>Tienda · Gatti S.A.</title>
 ...
 <div class="container cuerpoContenedor">   
  <div class="row">   
    <div class="col-md-8 col-xs-12" style="margin-top:10px">
      <div class="hidden-lg hidden-md">
        ...
        <form method="get">
          ...
          <span class="alert btn-block alert-warning">
            <a href="<?php echo BASE_URL ?>/tienda"><i class="fa fa-close"></i> Borrar filtros</a>
          </span>
          <?php } ?>
      ...
      <?php Portfolio_Read_Front(1,$categoria,$subcategoria,4) ?>
    </div>
    <div class="col-md-4 col-xs-12">
      <div class="hidden-sm hidden-xs">
        ...
        <?php Subcategoria_Read_Productos_Botones('',1); ?>
      </div>
      <br/>
