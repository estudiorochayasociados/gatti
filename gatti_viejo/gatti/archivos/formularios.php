...
<body>
	...
	<div class="container cuerpoContenedor"> 
		<div class="col-md-4 text-center">			
			<a href="<?php echo BASE_URL ?>/archivos/impositivo/CUIT AFIP.pdf"><br/>
		...
		<div class="col-md-4 text-center">			
			<a href="<?php echo BASE_URL ?>/archivos/impositivo/PADRON WEB.pdf"><br/>
				<img src="https://www.europair.com/web/img/web/decorado/pdf-ico.png" width="70%" /><br/><br/>
				<h4>PADRON WEB</h4>
			</a>
			<hr/>
		...
		<div class="col-md-4 text-center">			
			<a href="<?php echo BASE_URL ?>/archivos/impositivo/IIBB.pdf"><br/>
				<img src="https://www.europair.com/web/img/web/decorado/pdf-ico.png" width="70%" /><br/><br/>
				<h4>IIBB</h4>
			</a>
			<hr/>
