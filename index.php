    ...
    <div class="hidden-xs" style="position: relative;">
        <div id="myCarousel" class="sliderPrincipal carousel slide " data-ride="carousel" style="height:520px;overflow:hidden" data-pause="hover">
            <div class="carousel-inner" role="listbox">
                ...
                ?>
                    <div class="item <?= $key == 0 ? 'active' : '' ?>" style="background:url('<?= URL . '/' . $sli['imagenes']['0']['ruta']; ?>') center center/cover;height:520px">
                        <?php
    ...
    <div class="visible-xs" style="position: relative;">
        <div id="myCarouselM" class="sliderPrincipal carousel slide " data-ride="carousel" style="height:520px;overflow:hidden" data-pause="hover">
            <div class="carousel-inner" role="listbox">
                ...
                ?>
                    <div class="item <?= $key == 0 ? 'active' : '' ?>" style="background:url('<?= URL . '/' . $sli['imagenes']['0']['ruta']; ?>') center center/cover;height:400px">
                    </div>
                <?php
                }
                    ...
                    ?>
                        <div class="productosMasVistos">
                            <a href="<?= URL . '/producto/' . $funciones->normalizar_link($prod['data']["titulo"]) . '/' . $prod['data']['cod'] ?>">
                                ...
                                <div class="product-wrap" style="height:200px;background:url(<?= $prod['imagenes']['0']['ruta']; ?>) no-repeat center center/contain;">
                                </div>
                            </a>
                            ...
                            ?>
                                <div class="label label-danger" style="font-size: 12px;margin-bottom: 2px !important">
                                    <?= "<b>Antes: </b>$" . ($prod['data']["precio"]) ?>
                                </div>
                                <div class="label label-success" style="font-size: 12px;margin-bottom: 2px !important">
                            ...
                            <div class="clearfix"></div>
                            <br />
                            <a href="<?= URL . '/producto/' . $funciones->normalizar_link($prod['data']["titulo"]) . '/' . $prod['data']['cod'] ?>" class="btn btn-default">
                            ...
                            <div class="notasMasVistos">
                                ...
                                <div class="infoIndexNews">
                                    <p style="font-size:17px;padding: 10px 10px;text-align:left;margin-top:5px">
                                        ...
                                        <div class="clearfix"></div>
                                        <a href="<?= URL . '/novedad/' . $funciones->normalizar_link($nov['data']["titulo"]) . '/' . $nov['data']['cod'] ?>" class="btn btn-info fright">ver nota</a>
                                    </p>
                                </div>
                            </div>
                        </div>
